...
static void bench_m4_modmul_C25519_mont() {
    ...
    printf("C25519, mont, M4, modmul, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}

static void bench_m4_modsqr_C25519_mont() {
    ...
    printf("C25519, mont, M4, modsqr, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}

static void bench_m4_modadd_C25519_mont() {
    ...
    printf("C25519, mont, M4, modadd, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}

static void bench_m4_modsub_C25519_mont() {
    uint32_t a[Nlimbs_C25519_ct], b[Nlimbs_C25519_ct], c[Nlimbs_C25519_ct];
    bm_decls;
    ...
    printf("C25519, mont, M4, modsub, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}

static void bench_m4_modmli_C25519_mont() {
    ...
    printf("C25519, mont, M4, modmli, cycles, %" PRIu32 "\n", bm_result());
    usleep(1000); // To avoid SWO buffer overflows
}


void bench_m4_C25519_mont() {
    bench_m4_modmul_C25519_mont();
    bench_m4_modsqr_C25519_mont();
    bench_m4_modadd_C25519_mont();
    bench_m4_modsub_C25519_mont();
    bench_m4_modmli_C25519_mont();
