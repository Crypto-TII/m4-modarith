...
static void bench_m4_modmul_C448_mont() {
    ...
    printf("C448, mont, M4, modmul, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}

static void bench_m4_modsqr_C448_mont() {
    ...
    printf("C448, mont, M4, modsqr, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}

static void bench_m4_modadd_C448_mont() {
    ...
    printf("C448, mont, M4, modadd, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}

static void bench_m4_modsub_C448_mont() {
    uint32_t a[Nlimbs_C448_ct], b[Nlimbs_C448_ct], c[Nlimbs_C448_ct];
    bm_decls;
    ...
    printf("C448, mont, M4, modsub, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}

static void bench_m4_modmli_C448_mont() {
    ...
    printf("C448, mont, M4, modmli, cycles, %" PRIu32 "\n", bm_result());
    usleep(1000); // To avoid SWO buffer overflows
}


void bench_m4_C448_mont() {
    bench_m4_modmul_C448_mont();
    bench_m4_modsqr_C448_mont();
    bench_m4_modadd_C448_mont();
    bench_m4_modsub_C448_mont();
    bench_m4_modmli_C448_mont();
