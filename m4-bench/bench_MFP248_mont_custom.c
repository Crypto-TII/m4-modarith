...
static void bench_m4_modmul_MFP248_mont() {
    ...
    printf("MFP248, mont custom, M4, modmul, cycles, %" PRIu32 "\n", bm_result());
...
static void bench_m4_modsqr_MFP248_mont() {
    ...
    printf("MFP248, mont custom, M4, modsqr, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}
...
static void bench_m4_modadd_MFP248_mont() {
    ...
    printf("MFP248, mont custom, M4, modadd, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}
...
static void bench_m4_modsub_MFP248_mont() {
    ...
    printf("MFP248, mont custom, M4, modsub, cycles, %" PRIu32 "\n", bm_result());
    usleep(10000); // To avoid SWO buffer overflows
}
...
static void bench_m4_modmli_MFP248_mont() {
    ...
    printf("MFP248, mont custom, M4, modmli, cycles, %" PRIu32 "\n", bm_result());
    usleep(1000); // To avoid SWO buffer overflows
}


void bench_m4_MFP248_mont_custom() {
