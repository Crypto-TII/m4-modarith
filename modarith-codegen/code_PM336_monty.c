...
static void nres_PM336_ct(const spint *m, spint *n) {
    const spint c[12] = {0x0u, 0x0u, 0x9u, 0x0u, 0x0u, 0x0u, 0x0u, 0x0u, 0x0u, 0x0u, 0x0u, 0x0u};
    modmul_PM336_ct(m, c, n);
}
...
static void modsqrt_PM336_ct(const spint *x, const spint *h, spint *r) {
    ...
    spint b[12];
    spint v[12];
    spint z[12] = {0x559d3b8u, 0x804827fu, 0xeac636bu, 0x4538b93u, 0x95da4c9u, 0xa9fca8bu,
                   0x41f61edu, 0x3df798cu, 0x8b2b455u, 0x7811fc3u, 0x31ef52u,  0xf93fc3eu};
    spint s[12];
    spint y[12];
    if (h == NULL) {
        modpro_PM336_ct(x, y);
