...
#include "m4-codegen/code_MFP376_mont.c"
...
static void mul_fixed(void) {
    test_mul_fixed(12, mul_MFP376_ct);
}

static void mul_random(void) {
    test_mul_random(12, mul_MFP376_ct);
}

static void sqr_fixed(void) {
    test_sqr_fixed(12, sqr_MFP376_ct);
}

static void sqr_random(void) {
    test_sqr_random(12, sqr_MFP376_ct);
}

static void modmul_fixed(void) {
    test_modmul_fixed(12, 0, modmul_MFP376_ct, compare_with_ref_modmul_mont);
}

static void modmul_random(void) {
    test_modmul_random(12, modmul_MFP376_ct, compare_with_ref_modmul_mont);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(12, 0, modsqr_MFP376_ct, compare_with_ref_modmul_mont);
}

static void modsqr_random(void) {
    test_modsqr_random(12, modsqr_MFP376_ct, compare_with_ref_modmul_mont);
}

static void modmli_fixed(void) {
    test_modmli_fixed(12, modmli_MFP376_ct);
}

static void modmli_random(void) {
    test_modmli_random(12, modmli_MFP376_ct);
}

static void modadd_fixed(void) {
    test_op2inputs_fixed(12, 0, 0, modadd_MFP376_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(12, 0, 0, modadd_MFP376_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(12, 0, 1, modsub_MFP376_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(12, 0, 0, modsub_MFP376_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(12, 0, 1, modsub_MFP376_ct, compare_with_ref_modsub);
}

static void modcpy_fixed(void) {
    test_modcpy_fixed(12, modcpy_MFP376_ct);
}

static void modcpy_random(void) {
    test_modcpy_random(12, modcpy_MFP376_ct);
}

static void nres_fixed(void) {
    test_nres_fixed(12, 0, nres_MFP376_ct);
}

static void nres_random(void) {
    test_nres_random(12, 0, nres_MFP376_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(12, 0, redc_MFP376_ct, modfsb_MFP376_ct);
}

static void redc_random(void) {
    test_redc_random(12, 0, redc_MFP376_ct, modfsb_MFP376_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(12, 0, modneg_MFP376_ct);
}

static void modneg_random(void) {
    test_modneg_random(12, 0, modneg_MFP376_ct);
}

static void modinv_fixed(void) {
    test_modinv_fixed(12, nres_MFP376_ct, modinv_MFP376_ct, redc_MFP376_ct);
}

static void modinv_random(void) {
    test_modinv_random(12, nres_MFP376_ct, modinv_MFP376_ct, redc_MFP376_ct);
}

static void modfsb_fixed(void) {
    test_modfsb_fixed(12, modfsb_MFP376_ct);
}

static void modfsb_random(void) {
    test_modfsb_random(12, modfsb_MFP376_ct);
}

static void modis1_fixed(void) {
    test_modis1_fixed(12, nres_MFP376_ct, modis1_MFP376_ct);
}

static void modis1_random(void) {
    test_modis1_random(12, nres_MFP376_ct, modis1_MFP376_ct);
}

static void modis0_fixed(void) {
    test_modis0_fixed(12, nres_MFP376_ct, modis0_MFP376_ct);
}

static void modis0_random(void) {
    test_modis0_random(12, modis0_MFP376_ct);
}

static void modzer_random(void) {
    test_modzer_random(12, modzer_MFP376_ct);
}

static void modone_random(void) {
    test_modone_random(12, modone_MFP376_ct, redc_MFP376_ct);
}

static void modint_random(void) {
    test_modint_random(12, modint_MFP376_ct, redc_MFP376_ct);
}

static void modcmv_random(void) {
    test_modcmv_random(12, modcmv_MFP376_ct);
}

static void modcsw_random(void) {
    test_modcsw_random(12, modcsw_MFP376_ct);
}

static void modsqrt_fixed(void) {
    test_modsqrt_fixed(12, nres_MFP376_ct, modsqrt_MFP376_ct, redc_MFP376_ct);
}

static void modsqrt_random(void) {
    test_modsqrt_random(12, nres_MFP376_ct, modsqrt_MFP376_ct, redc_MFP376_ct);
}

static void modshr_fixed(void) {
    test_modshr_fixed(12, modshr_MFP376_ct);
}

static void modshr_random(void) {
    test_modshr_random(12, modshr_MFP376_ct);
}

static void modshl_fixed(void) {
    test_modshl_fixed(12, modshl_MFP376_ct);
}

static void modshl_random(void) {
    test_modshl_random(12, modshl_MFP376_ct);
}

static void mod2r_random(void) {
    test_mod2r_random(12, 0, mod2r_MFP376_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(12, 0, mod2r_MFP376_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(12, 0, modsign_MFP376_ct);
}

static void modsign_random(void) {
    test_modsign_random(12, 0, modsign_MFP376_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(12, 0, modcmp_MFP376_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(12, 0, modimp_MFP376_ct);
}

static void modimp_random(void) {
    test_modimp_random(12, 0, modimp_MFP376_ct);
}

static void modexp_random(void) {
    test_modexp_random(12, 0, modexp_MFP376_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(12, 0, nres_MFP376_ct, modadd_MFP376_ct, modsub_MFP376_ct, modmul_MFP376_ct, modsqr_MFP376_ct, modinv_MFP376_ct, modsqrt_MFP376_ct, redc_MFP376_ct, modfsb_MFP376_ct);
}

void test_MFP376_mont_ct(void) {
    printf("Testing MFP376_mont\n");
    mpz_set_str(realprime, "0x40ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 0);
    mpz_set(usedprime, realprime);
    mpz_set_ui(maxbound, 1);
    mpz_mul_2exp(maxbound, maxbound, 384);
