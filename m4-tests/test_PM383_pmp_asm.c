...
#include "m4-codegen/code_PM383_pmp_asm.c"
...
static void mul_fixed(void) {
    test_mul_fixed(12, mul_PM383_ct);
}

static void mul_random(void) {
    test_mul_random(12, mul_PM383_ct);
}

static void sqr_fixed(void) {
    test_sqr_fixed(12, sqr_PM383_ct);
}

static void sqr_random(void) {
    test_sqr_random(12, sqr_PM383_ct);
}

static void modmul_fixed(void) {
    test_modmul_fixed(12, 1, modmul_PM383_ct, compare_with_ref_modmul);
}

static void modmul_random(void) {
    test_modmul_random(12, modmul_PM383_ct, compare_with_ref_modmul);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(12, 1, modsqr_PM383_ct, compare_with_ref_modmul);
}

static void modsqr_random(void) {
    test_modsqr_random(12, modsqr_PM383_ct, compare_with_ref_modmul);
}

static void modred_fixed(void) {
    test_modred_fixed(12, 383, modred_PM383_ct);
}

static void modred_random(void) {
    test_modred_random(12, 383, modred_PM383_ct);
}

static void modmli_fixed(void) {
    test_modmli_fixed(12, modmli_PM383_ct);
}

static void modmli_random(void) {
    test_modmli_random(12, modmli_PM383_ct);
}

static void modadd_fixed(void) {
    test_op2inputs_fixed(12, 1, 0, modadd_PM383_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(12, 1, 0, modadd_PM383_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(12, 1, 1, modsub_PM383_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(12, 1, 0, modsub_PM383_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(12, 1, 1, modsub_PM383_ct, compare_with_ref_modsub);
}

static void modcpy_fixed(void) {
    test_modcpy_fixed(12, modcpy_PM383_ct);
}

static void modcpy_random(void) {
    test_modcpy_random(12, modcpy_PM383_ct);
}

static void nres_fixed(void) {
    test_nres_fixed(12, 1, nres_PM383_ct);
}

static void nres_random(void) {
    test_nres_random(12, 1, nres_PM383_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(12, 1, redc_PM383_ct, modfsb_PM383_ct);
}

static void redc_random(void) {
    test_redc_random(12, 1, redc_PM383_ct, modfsb_PM383_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(12, 1, modneg_PM383_ct);
}

static void modneg_random(void) {
    test_modneg_random(12, 1, modneg_PM383_ct);
}

static void modinv_fixed(void) {
    test_modinv_fixed(12, nres_PM383_ct, modinv_PM383_ct, redc_PM383_ct);
}

static void modinv_random(void) {
    test_modinv_random(12, nres_PM383_ct, modinv_PM383_ct, redc_PM383_ct);
}

static void modfsb_fixed(void) {
    test_modfsb_fixed(12, modfsb_PM383_ct);
}

static void modfsb_random(void) {
    test_modfsb_random(12, modfsb_PM383_ct);
}

static void modis1_fixed(void) {
    test_modis1_fixed(12, nres_PM383_ct, modis1_PM383_ct);
}

static void modis1_random(void) {
    test_modis1_random(12, nres_PM383_ct, modis1_PM383_ct);
}

static void modis0_fixed(void) {
    test_modis0_fixed(12, nres_PM383_ct, modis0_PM383_ct);
}

static void modis0_random(void) {
    test_modis0_random(12, modis0_PM383_ct);
}

static void modzer_random(void) {
    test_modzer_random(12, modzer_PM383_ct);
}

static void modone_random(void) {
    test_modone_random(12, modone_PM383_ct, redc_PM383_ct);
}

static void modint_random(void) {
    test_modint_random(12, modint_PM383_ct, redc_PM383_ct);
}

static void modcmv_random(void) {
    test_modcmv_random(12, modcmv_PM383_ct);
}

static void modcsw_random(void) {
    test_modcsw_random(12, modcsw_PM383_ct);
}

static void modsqrt_fixed(void) {
    test_modsqrt_fixed(12, nres_PM383_ct, modsqrt_PM383_ct, redc_PM383_ct);
}

static void modsqrt_random(void) {
    test_modsqrt_random(12, nres_PM383_ct, modsqrt_PM383_ct, redc_PM383_ct);
}

static void modshr_fixed(void) {
    test_modshr_fixed(12, modshr_PM383_ct);
}

static void modshr_random(void) {
    test_modshr_random(12, modshr_PM383_ct);
}

static void modshl_fixed(void) {
    test_modshl_fixed(12, modshl_PM383_ct);
}

static void modshl_random(void) {
    test_modshl_random(12, modshl_PM383_ct);
}

static void mod2r_random(void) {
    test_mod2r_random(12, 1, mod2r_PM383_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(12, 1, mod2r_PM383_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(12, 1, modsign_PM383_ct);
}

static void modsign_random(void) {
    test_modsign_random(12, 1, modsign_PM383_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(12, 1, modcmp_PM383_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(12, 1, modimp_PM383_ct);
}

static void modimp_random(void) {
    test_modimp_random(12, 1, modimp_PM383_ct);
}

static void modexp_random(void) {
    test_modexp_random(12, 1, modexp_PM383_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(12, 1, nres_PM383_ct, modadd_PM383_ct, modsub_PM383_ct, modmul_PM383_ct, modsqr_PM383_ct, modinv_PM383_ct, modsqrt_PM383_ct, redc_PM383_ct, modfsb_PM383_ct);
}

void test_PM383_pmp_asm_ct(void) {
    printf("Testing PM383_pmp_asm\n");
    mpz_set_ui(realprime, 1);
    mpz_mul_2exp(realprime, realprime, 383);
    mpz_sub_ui(realprime, realprime, 187);
