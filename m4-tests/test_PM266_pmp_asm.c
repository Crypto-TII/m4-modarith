...
#include "m4-codegen/code_PM266_pmp_asm.c"
...
static void modmul_fixed(void) {
    test_modmul_fixed(9, 1, modmul_PM266_ct, compare_with_ref_modmul);
}

static void modmul_random(void) {
    test_modmul_random(9, modmul_PM266_ct, compare_with_ref_modmul);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(9, 1, modsqr_PM266_ct, compare_with_ref_modmul);
}

static void modsqr_random(void) {
    test_modsqr_random(9, modsqr_PM266_ct, compare_with_ref_modmul);
}

static void modred_fixed(void) {
    test_modred_fixed(9, 266, modred_PM266_ct);
}

static void modred_random(void) {
    test_modred_random(9, 266, modred_PM266_ct);
}
...
static void modadd_fixed(void) {
    test_op2inputs_fixed(9, 1, 0, modadd_PM266_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(9, 1, 0, modadd_PM266_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(9, 1, 1, modsub_PM266_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(9, 1, 0, modsub_PM266_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(9, 1, 1, modsub_PM266_ct, compare_with_ref_modsub);
}
...
static void nres_fixed(void) {
    test_nres_fixed(9, 1, nres_PM266_ct);
}

static void nres_random(void) {
    test_nres_random(9, 1, nres_PM266_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(9, 1, redc_PM266_ct, modfsb_PM266_ct);
}

static void redc_random(void) {
    test_redc_random(9, 1, redc_PM266_ct, modfsb_PM266_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(9, 1, modneg_PM266_ct);
}

static void modneg_random(void) {
    test_modneg_random(9, 1, modneg_PM266_ct);
}
...
static void mod2r_random(void) {
    test_mod2r_random(9, 1, mod2r_PM266_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(9, 1, mod2r_PM266_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(9, 1, modsign_PM266_ct);
}

static void modsign_random(void) {
    test_modsign_random(9, 1, modsign_PM266_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(9, 1, modcmp_PM266_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(9, 1, modimp_PM266_ct);
}

static void modimp_random(void) {
    test_modimp_random(9, 1, modimp_PM266_ct);
}

static void modexp_random(void) {
    test_modexp_random(9, 1, modexp_PM266_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(9, 1, nres_PM266_ct, modadd_PM266_ct, modsub_PM266_ct, modmul_PM266_ct, modsqr_PM266_ct, modinv_PM266_ct, modsqrt_PM266_ct, redc_PM266_ct, modfsb_PM266_ct);
}

void test_PM266_pmp_asm_ct(void) {
    printf("Testing PM266_pmp_asm\n");
    mpz_set_ui(realprime, 1);
    mpz_mul_2exp(realprime, realprime, 266);
