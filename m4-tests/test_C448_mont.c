...
static void modmul_fixed(void) {
    test_modmul_fixed(14, 0, modmul_C448_ct, compare_with_ref_modmul_mont);
}

static void modmul_random(void) {
    test_modmul_random(14, modmul_C448_ct, compare_with_ref_modmul_mont);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(14, 0, modsqr_C448_ct, compare_with_ref_modmul_mont);
}

static void modsqr_random(void) {
    test_modsqr_random(14, modsqr_C448_ct, compare_with_ref_modmul_mont);
}
...
static void modadd_fixed(void) {
    test_op2inputs_fixed(14, 0, 0, modadd_C448_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(14, 0, 0, modadd_C448_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(14, 0, 1, modsub_C448_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(14, 0, 0, modsub_C448_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(14, 0, 1, modsub_C448_ct, compare_with_ref_modsub);
}
...
static void nres_fixed(void) {
    test_nres_fixed(14, 0, nres_C448_ct);
}

static void nres_random(void) {
    test_nres_random(14, 0, nres_C448_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(14, 0, redc_C448_ct, modfsb_C448_ct);
}

static void redc_random(void) {
    test_redc_random(14, 0, redc_C448_ct, modfsb_C448_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(14, 0, modneg_C448_ct);
}

static void modneg_random(void) {
    test_modneg_random(14, 0, modneg_C448_ct);
}
...
static void mod2r_random(void) {
    test_mod2r_random(14, 0, mod2r_C448_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(14, 0, mod2r_C448_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(14, 0, modsign_C448_ct);
}

static void modsign_random(void) {
    test_modsign_random(14, 0, modsign_C448_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(14, 0, modcmp_C448_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(14, 0, modimp_C448_ct);
}

static void modimp_random(void) {
    test_modimp_random(14, 0, modimp_C448_ct);
}

static void modexp_random(void) {
    test_modexp_random(14, 0, modexp_C448_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(14, 0, nres_C448_ct, modadd_C448_ct, modsub_C448_ct, modmul_C448_ct, modsqr_C448_ct, modinv_C448_ct, modsqrt_C448_ct, redc_C448_ct, modfsb_C448_ct);
}

void test_C448_mont_ct(void) {
    printf("Testing C448_mont\n");
