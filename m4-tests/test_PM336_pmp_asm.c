...
#include "m4-codegen/code_PM336_pmp_asm.c"
...
static void modmul_fixed(void) {
    test_modmul_fixed(11, 1, modmul_PM336_ct, compare_with_ref_modmul);
}

static void modmul_random(void) {
    test_modmul_random(11, modmul_PM336_ct, compare_with_ref_modmul);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(11, 1, modsqr_PM336_ct, compare_with_ref_modmul);
}

static void modsqr_random(void) {
    test_modsqr_random(11, modsqr_PM336_ct, compare_with_ref_modmul);
}

static void modred_fixed(void) {
    test_modred_fixed(11, 336, modred_PM336_ct);
}

static void modred_random(void) {
    test_modred_random(11, 336, modred_PM336_ct);
}
...
static void modadd_fixed(void) {
    test_op2inputs_fixed(11, 1, 0, modadd_PM336_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(11, 1, 0, modadd_PM336_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(11, 1, 1, modsub_PM336_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(11, 1, 0, modsub_PM336_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(11, 1, 1, modsub_PM336_ct, compare_with_ref_modsub);
}
...
static void nres_fixed(void) {
    test_nres_fixed(11, 1, nres_PM336_ct);
}

static void nres_random(void) {
    test_nres_random(11, 1, nres_PM336_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(11, 1, redc_PM336_ct, modfsb_PM336_ct);
}

static void redc_random(void) {
    test_redc_random(11, 1, redc_PM336_ct, modfsb_PM336_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(11, 1, modneg_PM336_ct);
}

static void modneg_random(void) {
    test_modneg_random(11, 1, modneg_PM336_ct);
}
...
static void mod2r_random(void) {
    test_mod2r_random(11, 1, mod2r_PM336_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(11, 1, mod2r_PM336_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(11, 1, modsign_PM336_ct);
}

static void modsign_random(void) {
    test_modsign_random(11, 1, modsign_PM336_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(11, 1, modcmp_PM336_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(11, 1, modimp_PM336_ct);
}

static void modimp_random(void) {
    test_modimp_random(11, 1, modimp_PM336_ct);
}

static void modexp_random(void) {
    test_modexp_random(11, 1, modexp_PM336_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(11, 1, nres_PM336_ct, modadd_PM336_ct, modsub_PM336_ct, modmul_PM336_ct, modsqr_PM336_ct, modinv_PM336_ct, modsqrt_PM336_ct, redc_PM336_ct, modfsb_PM336_ct);
}

void test_PM336_pmp_asm_ct(void) {
    printf("Testing PM336_pmp_asm\n");
    mpz_set_ui(realprime, 1);
    mpz_mul_2exp(realprime, realprime, 336);
    mpz_sub_ui(realprime, realprime, 3);
