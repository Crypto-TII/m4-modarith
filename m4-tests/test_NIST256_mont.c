...
static void mul_fixed(void) {
    test_mul_fixed(8, mul_NIST256_ct);
}

static void mul_random(void) {
    test_mul_random(8, mul_NIST256_ct);
}

static void sqr_fixed(void) {
    test_sqr_fixed(8, sqr_NIST256_ct);
}

static void sqr_random(void) {
    test_sqr_random(8, sqr_NIST256_ct);
}

static void modmul_fixed(void) {
    test_modmul_fixed(8, 0, modmul_NIST256_ct, compare_with_ref_modmul_mont);
}

static void modmul_random(void) {
    test_modmul_random(8, modmul_NIST256_ct, compare_with_ref_modmul_mont);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(8, 0, modsqr_NIST256_ct, compare_with_ref_modmul_mont);
}

static void modsqr_random(void) {
    test_modsqr_random(8, modsqr_NIST256_ct, compare_with_ref_modmul_mont);
}

static void modmli_fixed(void) {
    test_modmli_fixed(8, modmli_NIST256_ct);
}

static void modmli_random(void) {
    test_modmli_random(8, modmli_NIST256_ct);
}

static void modadd_fixed(void) {
    test_op2inputs_fixed(8, 0, 0, modadd_NIST256_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(8, 0, 0, modadd_NIST256_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(8, 0, 1, modsub_NIST256_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(8, 0, 0, modsub_NIST256_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(8, 0, 1, modsub_NIST256_ct, compare_with_ref_modsub);
}

static void modcpy_fixed(void) {
    test_modcpy_fixed(8, modcpy_NIST256_ct);
}

static void modcpy_random(void) {
    test_modcpy_random(8, modcpy_NIST256_ct);
}

static void nres_fixed(void) {
    test_nres_fixed(8, 0, nres_NIST256_ct);
}

static void nres_random(void) {
    test_nres_random(8, 0, nres_NIST256_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(8, 0, redc_NIST256_ct, modfsb_NIST256_ct);
}

static void redc_random(void) {
    test_redc_random(8, 0, redc_NIST256_ct, modfsb_NIST256_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(8, 0, modneg_NIST256_ct);
}

static void modneg_random(void) {
    test_modneg_random(8, 0, modneg_NIST256_ct);
}

static void modinv_fixed(void) {
    test_modinv_fixed(8, nres_NIST256_ct, modinv_NIST256_ct, redc_NIST256_ct);
}

static void modinv_random(void) {
    test_modinv_random(8, nres_NIST256_ct, modinv_NIST256_ct, redc_NIST256_ct);
}

static void modfsb_fixed(void) {
    test_modfsb_fixed(8, modfsb_NIST256_ct);
}

static void modfsb_random(void) {
    test_modfsb_random(8, modfsb_NIST256_ct);
}

static void modis1_fixed(void) {
    test_modis1_fixed(8, nres_NIST256_ct, modis1_NIST256_ct);
}

static void modis1_random(void) {
    test_modis1_random(8, nres_NIST256_ct, modis1_NIST256_ct);
}

static void modis0_fixed(void) {
    test_modis0_fixed(8, nres_NIST256_ct, modis0_NIST256_ct);
}

static void modis0_random(void) {
    test_modis0_random(8, modis0_NIST256_ct);
}

static void modzer_random(void) {
    test_modzer_random(8, modzer_NIST256_ct);
}

static void modone_random(void) {
    test_modone_random(8, modone_NIST256_ct, redc_NIST256_ct);
}

static void modint_random(void) {
    test_modint_random(8, modint_NIST256_ct, redc_NIST256_ct);
}

static void modcmv_random(void) {
    test_modcmv_random(8, modcmv_NIST256_ct);
}

static void modcsw_random(void) {
    test_modcsw_random(8, modcsw_NIST256_ct);
}

static void modsqrt_fixed(void) {
    test_modsqrt_fixed(8, nres_NIST256_ct, modsqrt_NIST256_ct, redc_NIST256_ct);
}

static void modsqrt_random(void) {
    test_modsqrt_random(8, nres_NIST256_ct, modsqrt_NIST256_ct, redc_NIST256_ct);
}

static void modshr_fixed(void) {
    test_modshr_fixed(8, modshr_NIST256_ct);
}

static void modshr_random(void) {
    test_modshr_random(8, modshr_NIST256_ct);
}

static void modshl_fixed(void) {
    test_modshl_fixed(8, modshl_NIST256_ct);
}

static void modshl_random(void) {
    test_modshl_random(8, modshl_NIST256_ct);
}

static void mod2r_random(void) {
    test_mod2r_random(8, 0, mod2r_NIST256_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(8, 0, mod2r_NIST256_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(8, 0, modsign_NIST256_ct);
}

static void modsign_random(void) {
    test_modsign_random(8, 0, modsign_NIST256_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(8, 0, modcmp_NIST256_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(8, 0, modimp_NIST256_ct);
}

static void modimp_random(void) {
    test_modimp_random(8, 0, modimp_NIST256_ct);
}

static void modexp_random(void) {
    test_modexp_random(8, 0, modexp_NIST256_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(8, 0, nres_NIST256_ct, modadd_NIST256_ct, modsub_NIST256_ct, modmul_NIST256_ct, modsqr_NIST256_ct, modinv_NIST256_ct, modsqrt_NIST256_ct, redc_NIST256_ct, modfsb_NIST256_ct);
}

void test_NIST256_mont_ct(void) {
    printf("Testing NIST256_mont\n");
    mpz_set_str(realprime, "0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff", 0);
