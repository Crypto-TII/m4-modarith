...
#include "m4-codegen/code_PM512_mont.c"
...
static void modmul_fixed(void) {
    test_modmul_fixed(16, 0, modmul_PM512_ct, compare_with_ref_modmul_mont);
}

static void modmul_random(void) {
    test_modmul_random(16, modmul_PM512_ct, compare_with_ref_modmul_mont);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(16, 0, modsqr_PM512_ct, compare_with_ref_modmul_mont);
}

static void modsqr_random(void) {
    test_modsqr_random(16, modsqr_PM512_ct, compare_with_ref_modmul_mont);
}
...
static void modadd_fixed(void) {
    test_op2inputs_fixed(16, 0, 0, modadd_PM512_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(16, 0, 0, modadd_PM512_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(16, 0, 1, modsub_PM512_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(16, 0, 0, modsub_PM512_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(16, 0, 1, modsub_PM512_ct, compare_with_ref_modsub);
}
...
static void nres_fixed(void) {
    test_nres_fixed(16, 0, nres_PM512_ct);
}

static void nres_random(void) {
    test_nres_random(16, 0, nres_PM512_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(16, 0, redc_PM512_ct, modfsb_PM512_ct);
}

static void redc_random(void) {
    test_redc_random(16, 0, redc_PM512_ct, modfsb_PM512_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(16, 0, modneg_PM512_ct);
}

static void modneg_random(void) {
    test_modneg_random(16, 0, modneg_PM512_ct);
}
...
static void mod2r_random(void) {
    test_mod2r_random(16, 0, mod2r_PM512_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(16, 0, mod2r_PM512_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(16, 0, modsign_PM512_ct);
}

static void modsign_random(void) {
    test_modsign_random(16, 0, modsign_PM512_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(16, 0, modcmp_PM512_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(16, 0, modimp_PM512_ct);
}

static void modimp_random(void) {
    test_modimp_random(16, 0, modimp_PM512_ct);
}

static void modexp_random(void) {
    test_modexp_random(16, 0, modexp_PM512_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(16, 0, nres_PM512_ct, modadd_PM512_ct, modsub_PM512_ct, modmul_PM512_ct, modsqr_PM512_ct, modinv_PM512_ct, modsqrt_PM512_ct, redc_PM512_ct, modfsb_PM512_ct);
}

void test_PM512_mont_ct(void) {
    printf("Testing PM512_mont\n");
    mpz_set_str(realprime, "0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffdc7", 0);
