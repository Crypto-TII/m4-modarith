...
#include "m4-codegen/code_PM383_mont.c"
...
static void modmul_fixed(void) {
    test_modmul_fixed(12, 0, modmul_PM383_ct, compare_with_ref_modmul_mont);
}

static void modmul_random(void) {
    test_modmul_random(12, modmul_PM383_ct, compare_with_ref_modmul_mont);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(12, 0, modsqr_PM383_ct, compare_with_ref_modmul_mont);
}

static void modsqr_random(void) {
    test_modsqr_random(12, modsqr_PM383_ct, compare_with_ref_modmul_mont);
}
...
static void modadd_fixed(void) {
    test_op2inputs_fixed(12, 0, 0, modadd_PM383_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(12, 0, 0, modadd_PM383_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(12, 0, 1, modsub_PM383_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(12, 0, 0, modsub_PM383_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(12, 0, 1, modsub_PM383_ct, compare_with_ref_modsub);
}
...
static void nres_fixed(void) {
    test_nres_fixed(12, 0, nres_PM383_ct);
}

static void nres_random(void) {
    test_nres_random(12, 0, nres_PM383_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(12, 0, redc_PM383_ct, modfsb_PM383_ct);
}

static void redc_random(void) {
    test_redc_random(12, 0, redc_PM383_ct, modfsb_PM383_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(12, 0, modneg_PM383_ct);
}

static void modneg_random(void) {
    test_modneg_random(12, 0, modneg_PM383_ct);
}
...
static void mod2r_random(void) {
    test_mod2r_random(12, 0, mod2r_PM383_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(12, 0, mod2r_PM383_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(12, 0, modsign_PM383_ct);
}

static void modsign_random(void) {
    test_modsign_random(12, 0, modsign_PM383_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(12, 0, modcmp_PM383_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(12, 0, modimp_PM383_ct);
}

static void modimp_random(void) {
    test_modimp_random(12, 0, modimp_PM383_ct);
}

static void modexp_random(void) {
    test_modexp_random(12, 0, modexp_PM383_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(12, 0, nres_PM383_ct, modadd_PM383_ct, modsub_PM383_ct, modmul_PM383_ct, modsqr_PM383_ct, modinv_PM383_ct, modsqrt_PM383_ct, redc_PM383_ct, modfsb_PM383_ct);
}

void test_PM383_mont_ct(void) {
    printf("Testing PM383_mont\n");
    mpz_set_str(realprime, "0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff45", 0);
