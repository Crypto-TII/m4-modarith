...
#include "m4-codegen/code_C25519_mont.c"
...
static void modmul_fixed(void) {
    test_modmul_fixed(8, 0, modmul_C25519_ct, compare_with_ref_modmul_mont);
}

static void modmul_random(void) {
    test_modmul_random(8, modmul_C25519_ct, compare_with_ref_modmul_mont);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(8, 0, modsqr_C25519_ct, compare_with_ref_modmul_mont);
}

static void modsqr_random(void) {
    test_modsqr_random(8, modsqr_C25519_ct, compare_with_ref_modmul_mont);
}
...
static void modadd_fixed(void) {
    test_op2inputs_fixed(8, 0, 0, modadd_C25519_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(8, 0, 0, modadd_C25519_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(8, 0, 1, modsub_C25519_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(8, 0, 0, modsub_C25519_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(8, 0, 1, modsub_C25519_ct, compare_with_ref_modsub);
}
...
static void nres_fixed(void) {
    test_nres_fixed(8, 0, nres_C25519_ct);
}

static void nres_random(void) {
    test_nres_random(8, 0, nres_C25519_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(8, 0, redc_C25519_ct, modfsb_C25519_ct);
}

static void redc_random(void) {
    test_redc_random(8, 0, redc_C25519_ct, modfsb_C25519_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(8, 0, modneg_C25519_ct);
}

static void modneg_random(void) {
    test_modneg_random(8, 0, modneg_C25519_ct);
}
...
static void mod2r_random(void) {
    test_mod2r_random(8, 0, mod2r_C25519_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(8, 0, mod2r_C25519_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(8, 0, modsign_C25519_ct);
}

static void modsign_random(void) {
    test_modsign_random(8, 0, modsign_C25519_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(8, 0, modcmp_C25519_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(8, 0, modimp_C25519_ct);
}

static void modimp_random(void) {
    test_modimp_random(8, 0, modimp_C25519_ct);
}

static void modexp_random(void) {
    test_modexp_random(8, 0, modexp_C25519_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(8, 0, nres_C25519_ct, modadd_C25519_ct, modsub_C25519_ct, modmul_C25519_ct, modsqr_C25519_ct, modinv_C25519_ct, modsqrt_C25519_ct, redc_C25519_ct, modfsb_C25519_ct);
}

void test_C25519_mont_ct(void) {
    printf("Testing C25519_mont\n");
    mpz_set_str(realprime, "0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffed", 0);
