...
#include "m4-codegen/code_NIST521_pmp_asm.c"
...
static void modmul_fixed(void) {
    test_modmul_fixed(17, 1, modmul_NIST521_ct, compare_with_ref_modmul);
}

static void modmul_random(void) {
    test_modmul_random(17, modmul_NIST521_ct, compare_with_ref_modmul);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(17, 1, modsqr_NIST521_ct, compare_with_ref_modmul);
}

static void modsqr_random(void) {
    test_modsqr_random(17, modsqr_NIST521_ct, compare_with_ref_modmul);
}

static void modred_fixed(void) {
    test_modred_fixed(17, 521, modred_NIST521_ct);
}

static void modred_random(void) {
    test_modred_random(17, 521, modred_NIST521_ct);
}
...
static void modadd_fixed(void) {
    test_op2inputs_fixed(17, 1, 0, modadd_NIST521_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(17, 1, 0, modadd_NIST521_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(17, 1, 1, modsub_NIST521_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(17, 1, 0, modsub_NIST521_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(17, 1, 1, modsub_NIST521_ct, compare_with_ref_modsub);
}
...
static void nres_fixed(void) {
    test_nres_fixed(17, 1, nres_NIST521_ct);
}

static void nres_random(void) {
    test_nres_random(17, 1, nres_NIST521_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(17, 1, redc_NIST521_ct, modfsb_NIST521_ct);
}

static void redc_random(void) {
    test_redc_random(17, 1, redc_NIST521_ct, modfsb_NIST521_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(17, 1, modneg_NIST521_ct);
}

static void modneg_random(void) {
    test_modneg_random(17, 1, modneg_NIST521_ct);
}
...
static void mod2r_random(void) {
    test_mod2r_random(17, 1, mod2r_NIST521_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(17, 1, mod2r_NIST521_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(17, 1, modsign_NIST521_ct);
}

static void modsign_random(void) {
    test_modsign_random(17, 1, modsign_NIST521_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(17, 1, modcmp_NIST521_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(17, 1, modimp_NIST521_ct);
}

static void modimp_random(void) {
    test_modimp_random(17, 1, modimp_NIST521_ct);
}

static void modexp_random(void) {
    test_modexp_random(17, 1, modexp_NIST521_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(17, 1, nres_NIST521_ct, modadd_NIST521_ct, modsub_NIST521_ct, modmul_NIST521_ct, modsqr_NIST521_ct, modinv_NIST521_ct, modsqrt_NIST521_ct, redc_NIST521_ct, modfsb_NIST521_ct);
}

void test_NIST521_pmp_asm_ct(void) {
    printf("Testing NIST521_pmp_asm\n");
    mpz_set_ui(realprime, 1);
    mpz_mul_2exp(realprime, realprime, 521);
    mpz_sub_ui(realprime, realprime, 1);
