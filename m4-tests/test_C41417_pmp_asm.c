...
#include "m4-codegen/code_C41417_pmp_asm.c"
...
static void modmul_fixed(void) {
    test_modmul_fixed(13, 1, modmul_C41417_ct, compare_with_ref_modmul);
}

static void modmul_random(void) {
    test_modmul_random(13, modmul_C41417_ct, compare_with_ref_modmul);
}

static void modsqr_fixed(void) {
    test_modsqr_fixed(13, 1, modsqr_C41417_ct, compare_with_ref_modmul);
}

static void modsqr_random(void) {
    test_modsqr_random(13, modsqr_C41417_ct, compare_with_ref_modmul);
}

static void modred_fixed(void) {
    test_modred_fixed(13, 414, modred_C41417_ct);
}

static void modred_random(void) {
    test_modred_random(13, 414, modred_C41417_ct);
}
...
static void modadd_fixed(void) {
    test_op2inputs_fixed(13, 1, 0, modadd_C41417_ct, compare_with_ref_modadd);
}

static void modadd_random(void) {
    test_op2inputs_random(13, 1, 0, modadd_C41417_ct, compare_with_ref_modadd);
}

static void modsub_fixed(void) {
    test_op2inputs_fixed(13, 1, 1, modsub_C41417_ct, compare_with_ref_modsub);
}

static void modsub_random(void) {
    test_op2inputs_random(13, 1, 0, modsub_C41417_ct, compare_with_ref_modsub);
}
...
static void modsub_negate_random(void) {
    test_op2inputs_random(13, 1, 1, modsub_C41417_ct, compare_with_ref_modsub);
}
...
static void nres_fixed(void) {
    test_nres_fixed(13, 1, nres_C41417_ct);
}

static void nres_random(void) {
    test_nres_random(13, 1, nres_C41417_ct);
}

static void redc_fixed(void) {
    test_redc_fixed(13, 1, redc_C41417_ct, modfsb_C41417_ct);
}

static void redc_random(void) {
    test_redc_random(13, 1, redc_C41417_ct, modfsb_C41417_ct);
}

static void modneg_fixed(void) {
    test_modneg_fixed(13, 1, modneg_C41417_ct);
}

static void modneg_random(void) {
    test_modneg_random(13, 1, modneg_C41417_ct);
}
...
static void mod2r_random(void) {
    test_mod2r_random(13, 1, mod2r_C41417_ct);
}

static void mod2r_fixed(void) {
    test_mod2r_fixed(13, 1, mod2r_C41417_ct);
}

static void modsign_fixed(void) {
    test_modsign_fixed(13, 1, modsign_C41417_ct);
}

static void modsign_random(void) {
    test_modsign_random(13, 1, modsign_C41417_ct);
}

static void modcmp_random(void) {
    test_modcmp_random(13, 1, modcmp_C41417_ct);
}

static void modimp_fixed(void) {
    test_modimp_fixed(13, 1, modimp_C41417_ct);
}

static void modimp_random(void) {
    test_modimp_random(13, 1, modimp_C41417_ct);
}

static void modexp_random(void) {
    test_modexp_random(13, 1, modexp_C41417_ct);
}

static void acceptance_random(void) {
    test_acceptance_random(13, 1, nres_C41417_ct, modadd_C41417_ct, modsub_C41417_ct, modmul_C41417_ct, modsqr_C41417_ct, modinv_C41417_ct, modsqrt_C41417_ct, redc_C41417_ct, modfsb_C41417_ct);
}

void test_C41417_pmp_asm_ct(void) {
    printf("Testing C41417_pmp_asm\n");
    mpz_set_ui(realprime, 1);
    mpz_mul_2exp(realprime, realprime, 414);
    mpz_sub_ui(realprime, realprime, 17);
