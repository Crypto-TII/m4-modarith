...
static void modred_C41417_ct(const spint *c, spint *r) {
    spint t, rH, cc = 0;

    rH = c[12];
    UMAAL(rH, cc, c[25], 17 << 2);

    cc = 17 * ((cc << 2) | (rH >> 30));
    rH &= 0x3fffffff;

    t = c[0];
    UMAAL(t, cc, c[13], 17 << 2);
    r[0] = t;

    t = c[1];
    UMAAL(t, cc, c[14], 17 << 2);
    r[1] = t;

    t = c[2];
    UMAAL(t, cc, c[15], 17 << 2);
    r[2] = t;

    t = c[3];
    UMAAL(t, cc, c[16], 17 << 2);
    r[3] = t;

    t = c[4];
    UMAAL(t, cc, c[17], 17 << 2);
    r[4] = t;

    t = c[5];
    UMAAL(t, cc, c[18], 17 << 2);
    r[5] = t;

    t = c[6];
    UMAAL(t, cc, c[19], 17 << 2);
    r[6] = t;

    t = c[7];
    UMAAL(t, cc, c[20], 17 << 2);
    r[7] = t;

    t = c[8];
    UMAAL(t, cc, c[21], 17 << 2);
    r[8] = t;

    t = c[9];
    UMAAL(t, cc, c[22], 17 << 2);
    r[9] = t;

    t = c[10];
    UMAAL(t, cc, c[23], 17 << 2);
    r[10] = t;

    t = c[11];
    UMAAL(t, cc, c[24], 17 << 2);
    r[11] = t;
...
inline static void modadd_C41417_ct(const spint *a, const spint *b, spint *res) {
    spint t = 0;
    spint a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12;
    spint b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12;
    a12 = a[12];
    b12 = b[12];
    UMAAL(a12, t, 1, b12);
    t = 17 * ((a12 >> 30) + (t << 2));
