/* Autogenerated: './src/ExtractionOCaml/fiat_crypto' unsaturated-solinas --inline --static --use-value-barrier 25519 32 '(auto)' '2^255 - 19' */
...
/*
 * The function fiat_25519_carry_add adds two field elements.
 *
 * Postconditions:
 *   eval out1 mod m = (eval arg1 + eval arg2) mod m
 *
 */
static FIAT_25519_FIAT_INLINE void fiat_25519_carry_add(fiat_25519_tight_field_element out1, const fiat_25519_tight_field_element arg1, const fiat_25519_tight_field_element arg2) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
...
/*
 * The function fiat_25519_carry_sub subtracts two field elements.
 *
 * Postconditions:
 *   eval out1 mod m = (eval arg1 - eval arg2) mod m
 *
 */
static FIAT_25519_FIAT_INLINE void fiat_25519_carry_sub(fiat_25519_tight_field_element out1, const fiat_25519_tight_field_element arg1, const fiat_25519_tight_field_element arg2) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
  ...
  uint32_t x22;
  x1 = ((UINT32_C(0x7ffffda) + (arg1[0])) - (arg2[0]));
  x2 = ((x1 >> 26) + ((UINT32_C(0x3fffffe) + (arg1[1])) - (arg2[1])));
  x3 = ((x2 >> 25) + ((UINT32_C(0x7fffffe) + (arg1[2])) - (arg2[2])));
  x4 = ((x3 >> 26) + ((UINT32_C(0x3fffffe) + (arg1[3])) - (arg2[3])));
  x5 = ((x4 >> 25) + ((UINT32_C(0x7fffffe) + (arg1[4])) - (arg2[4])));
  x6 = ((x5 >> 26) + ((UINT32_C(0x3fffffe) + (arg1[5])) - (arg2[5])));
  x7 = ((x6 >> 25) + ((UINT32_C(0x7fffffe) + (arg1[6])) - (arg2[6])));
  x8 = ((x7 >> 26) + ((UINT32_C(0x3fffffe) + (arg1[7])) - (arg2[7])));
  x9 = ((x8 >> 25) + ((UINT32_C(0x7fffffe) + (arg1[8])) - (arg2[8])));
  x10 = ((x9 >> 26) + ((UINT32_C(0x3fffffe) + (arg1[9])) - (arg2[9])));
  x11 = ((x1 & UINT32_C(0x3ffffff)) + ((x10 >> 25) * UINT8_C(0x13)));
  x12 = ((fiat_25519_uint1)(x11 >> 26) + (x2 & UINT32_C(0x1ffffff)));
  x13 = (x11 & UINT32_C(0x3ffffff));
  x14 = (x12 & UINT32_C(0x1ffffff));
...
/*
 * The function fiat_25519_carry_opp negates a field element.
 *
 * Postconditions:
 *   eval out1 mod m = -eval arg1 mod m
 *
 */
static FIAT_25519_FIAT_INLINE void fiat_25519_carry_opp(fiat_25519_tight_field_element out1, const fiat_25519_tight_field_element arg1) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
  ...
  uint32_t x22;
  x1 = (UINT32_C(0x7ffffda) - (arg1[0]));
  x2 = ((fiat_25519_uint1)(x1 >> 26) + (UINT32_C(0x3fffffe) - (arg1[1])));
  x3 = ((fiat_25519_uint1)(x2 >> 25) + (UINT32_C(0x7fffffe) - (arg1[2])));
  x4 = ((fiat_25519_uint1)(x3 >> 26) + (UINT32_C(0x3fffffe) - (arg1[3])));
  x5 = ((fiat_25519_uint1)(x4 >> 25) + (UINT32_C(0x7fffffe) - (arg1[4])));
  x6 = ((fiat_25519_uint1)(x5 >> 26) + (UINT32_C(0x3fffffe) - (arg1[5])));
  x7 = ((fiat_25519_uint1)(x6 >> 25) + (UINT32_C(0x7fffffe) - (arg1[6])));
  x8 = ((fiat_25519_uint1)(x7 >> 26) + (UINT32_C(0x3fffffe) - (arg1[7])));
  x9 = ((fiat_25519_uint1)(x8 >> 25) + (UINT32_C(0x7fffffe) - (arg1[8])));
  x10 = ((fiat_25519_uint1)(x9 >> 26) + (UINT32_C(0x3fffffe) - (arg1[9])));
  x11 = ((x1 & UINT32_C(0x3ffffff)) + ((fiat_25519_uint1)(x10 >> 25) * UINT8_C(0x13)));
  x12 = ((fiat_25519_uint1)(x11 >> 26) + (x2 & UINT32_C(0x1ffffff)));
  x13 = (x11 & UINT32_C(0x3ffffff));
  x14 = (x12 & UINT32_C(0x1ffffff));
  x15 = ((fiat_25519_uint1)(x12 >> 25) + (x3 & UINT32_C(0x3ffffff)));
